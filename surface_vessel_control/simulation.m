...
PARAMETERS.SIMULATION.SAMPLING_TIME = 0.01;
PARAMETERS.SIMULATION.DISTURBANCE_FREQUENCY_MAX = 2*[2; 2; 2];%0.2*[.5; .6; .6];

if PARAMETERS.SIMULATION.INITIAL_CONDITIONS == 0
    % x, y, yaw, dot_x, dot_y, dot_yaw, u, v, r
    PARAMETERS.SIMULATION.INITIAL_STATE = [0 0 0 0 0 0 0 0 0]'; 
else
    % x, y, yaw, dot_x, dot_y, dot_yaw, u, v, r
    PARAMETERS.SIMULATION.INITIAL_STATE = [0 0 pi/3 0 0 0 0 0 0]'; 
end
